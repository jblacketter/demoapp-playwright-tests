...
3. For plan reviews: verify `.claude/handoff/phases/[phase].md` exists
4. For impl reviews: verify implementation is complete

5. Create cycle document at `.claude/handoff/handoffs/[phase]_[type]_cycle.md`:
...
## Reference
- Plan: `.claude/handoff/phases/[phase].md`
...
2. Read the cycle file `.claude/handoff/handoffs/[phase]_*_cycle.md`
...
Agent: "Reading cycle... It's your turn to review.
        ...
        Referenced plan: .claude/handoff/phases/foundation.md
