...
1. Gather context:
   ...
   - Check `.claude/handoff/phases/` for completed phases
   - Check `docs/decision_log.md` for relevant decisions

2. Create the phase plan in `.claude/handoff/phases/[phase_name].md`:
...
2. Read any feedback from `.claude/handoff/handoffs/[phase_name]_plan_feedback.md`
...
1. List all phases in `.claude/handoff/phases/`
...
[Creates .claude/handoff/phases/foundation.md with filled template]
