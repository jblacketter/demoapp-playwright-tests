...
## Prerequisites
- Phase plan exists in `.claude/handoff/phases/[phase_name].md`
...
4. Create implementation tracking in `.claude/handoff/phases/[phase_name]_impl.md`:
...
**Plan:** .claude/handoff/phases/[phase_name].md
...
Handoff created for reviewer at `.claude/handoff/handoffs/foundation_impl_handoff.md`"
