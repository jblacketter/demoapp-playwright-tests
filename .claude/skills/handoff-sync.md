...
1. Read current project state:
   ...
   - Phase details from `.claude/handoff/phases/[current].md`
   - Pending handoffs from `.claude/handoff/handoffs/`
   - Recent decisions from `docs/decision_log.md`
   - Open escalations from `.claude/handoff/escalations/`
...
## Key Files
- Phase plan: `.claude/handoff/phases/[phase].md`
- Latest handoff: `.claude/handoff/handoffs/[file].md`
...
Save feedback to `.claude/handoff/handoffs/[phase]_[type]_feedback.md`
```
