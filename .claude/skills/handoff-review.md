...
1. Read the handoff document: `.claude/handoff/handoffs/[phase_name]_plan_handoff.md`
2. Read the phase plan: `.claude/handoff/phases/[phase_name].md`
...
5. Save to `.claude/handoff/handoffs/[phase_name]_plan_feedback.md`
...
5. Save to `.claude/handoff/handoffs/[phase_name]_impl_feedback.md`
...
1. Check for pending handoffs in `.claude/handoff/handoffs/`
