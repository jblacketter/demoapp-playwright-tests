...
3. Create escalation document at `.claude/handoff/escalations/[date]_[topic].md`:
...
4. Prompt: "Escalation created. Human needs to review `.claude/handoff/escalations/[file].md` and mark their decision."

### List Escalations (`/handoff-escalate list`)

1. List all files in `.claude/handoff/escalations/`
...
"Escalation created. Please review `.claude/handoff/escalations/2026-01-17_database_choice.md` and mark your decision."
