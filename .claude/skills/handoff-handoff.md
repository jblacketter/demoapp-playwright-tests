...
1. Read the phase plan from `.claude/handoff/phases/[phase_name].md`
2. Read `ai-handoff.yaml` to get agent names
3. Create `.claude/handoff/handoffs/[phase_name]_plan_handoff.md`:
...
## Phase Plan Location
`.claude/handoff/phases/[phase_name].md`
...
Please provide feedback in `.claude/handoff/handoffs/[phase_name]_plan_feedback.md` using the feedback template.
...
3. Create `.claude/handoff/handoffs/[phase_name]_impl_handoff.md`:
...
1. Check `.claude/handoff/handoffs/` for pending handoffs
...
1. Check for feedback files:
   - `.claude/handoff/handoffs/[phase_name]_plan_feedback.md`
   - `.claude/handoff/handoffs/[phase_name]_impl_feedback.md`
...
1. List all handoff documents in `.claude/handoff/handoffs/`
...
"Handoff created at `.claude/handoff/handoffs/foundation_plan_handoff.md`. Reviewer can now review."
